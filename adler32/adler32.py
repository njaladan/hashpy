# very similar to the fletcher checksum
# contains a prime modulus for an increase in error-
# checking functionality


#interesting - adler32 computed over 8 bit instead of 16 bit words
#this makes endianness not matter, but slower
...
def main():
    print('Adler-32 checksum calculator')
