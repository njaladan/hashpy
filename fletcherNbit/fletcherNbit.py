...
def main():
    ...
    while(True):
        ...
        hashobj16 = Fletcher16()
        hashobj16.update(data)
        hexdigest16 = hashobj16.hexdigest()
        
        hashobj32 = Fletcher32()
        hashobj32.update(data)
        hexdigest32 = hashobj32.hexdigest()
        
        hashobj64 = Fletcher64()
        hashobj64.update(data)
        hexdigest64 = hashobj64.hexdigest()
            
        print("16-bit: " + hexdigest16)
        print("32-bit: " + hexdigest32)
        print("64-bit: " + hexdigest64)
